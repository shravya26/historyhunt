...
<html lang="en" style="margin-top:-60px;">
  ...
  <body style='background-image:url("yoyo.jpeg");background-repeat: no-repeat;background-position:center;background-size:cover;'>	<nav class="navbar navbar-inverse">
      <div class="container">
    ...
    <div class="container">
	<html style="border-top:2px solid black;">
		<form method="post" action="alogin.jsp" class="form-signin">
       <center><div  style='text-shadow:2px 2px 6px grey;margin-top:30%;padding:5px 10px;font-size:35px;font-weight:bolder;font-family: Cooper Black'>Admin <span style='color:#337ab7;'>Login</span> </div></center>     
			...
			<button class="btn btn-lg btn-primary btn-block" style="margin-top:10%;width: 100%;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)" type="submit">Log In</button>
		</form>
    </div> <!-- /container -->
  </body>
</html>
